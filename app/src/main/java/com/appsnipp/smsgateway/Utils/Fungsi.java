...
//                PushService.writeLog("SEND FAILED: " + number + " " + message+"\n\n"+ex.getMessage(), cx);
    ...
    public static void sendNotification(String to, String msg) {
        ...
        if(Build.VERSION.SDK_INT>25) {
            ...
            NotificationChannel androidChannel = new NotificationChannel("appsnipp.education",
        ...
        NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(App.getInstance(),"appsnipp.education")
